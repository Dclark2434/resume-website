# TODO: update variable and resource names to be consistent style. Snake case is beet practice stick to it.  This is what you get for trying to learn multiple languages...
